    ...
    <section className="border-b border-border/40 py-16 lg:py-24">
      <div className="container">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="text-3xl font-bold text-foreground text-balance">Featured Markets</h2>
            <p className="mt-2 text-muted-foreground">Most popular prediction markets right now</p>
          </div>
